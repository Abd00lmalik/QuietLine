...
- lender: C2FLR and certified testUSDT0;
- protocol operator: C2FLR and certified testUSDT0 for the backstop;
- relayer: C2FLR only.
...
2. Deposit 10 FXRP.
3. Request 3 testUSDT0 for 14 days with a 12% maximum APR.
...
1. Deposit enough testUSDT0 to cover current debt.
