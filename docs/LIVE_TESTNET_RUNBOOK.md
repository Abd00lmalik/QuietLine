...
- borrower: C2FLR and certified FXRP;
...
5. Open Earn and activate a mandate:
   - amount: the lender's full available USD₮0 balance;
   - minimum APR: 8%;
   - terms: 7, 14, and 30 days;
   - per-borrower cap: the full mandate amount.
...
2. Deposit 10 FXRP.
3. Request any positive USD₮0 amount that remains below 50% initial LTV.
4. Show the live quote countdown and private lender match. If eligible
   liquidity is lower than the requested amount, show the private partial quote.
...
5. Verify borrower FXRP becomes privately available.
6. Withdraw a small FXRP amount and show the public Coston2 payout.
