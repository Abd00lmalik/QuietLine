...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "The committed Coston2 market is FXRP collateral against USDT0 liquidity, with 7, 14, and 30 day fixed terms.",
  },
  {
        ...
        <main id="main-content">
          <section className="hero">
            <div className="hero__copy">
              ...
              <p className="hero__body">
                Borrow USDT0 against FXRP without publishing your lender terms, debt,
          ...
          <section id="privacy" className="privacy-section">
            ...
            <div className="privacy-columns">
              <article className="privacy-column privacy-column--private">
                ...
                <ul>
                  <li><ChevronRight size={15} /> Internal FXRP and USDT0 balances</li>
          ...
          <section className="cta-band">
            <div>
              ...
              <p>Connect a funded wallet, deposit FXRP, receive a live lender quote, borrow USDT0, stress the position, and repay.</p>
            </div>
            <Link className="button button--primary button--large" to="/app">
