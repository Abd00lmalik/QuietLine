...
library QuietPolicy {
    uint8 internal constant PROTOCOL_VERSION = 1;
    ...
    uint256 internal constant MIN_BORROW = 1_000_000;
    uint256 internal constant MAX_BORROW = 5_000_000;
    uint256 internal constant DAILY_BORROW_CAP = 8_000_000;
